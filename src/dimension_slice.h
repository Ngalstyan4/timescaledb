...
extern DimensionVec *  dimension_slice_scan_limit(int32 dimension_id, int64 coordinate,
						  int limit);
...
extern int	     dimension_slice_delete_by_dimension_id(int32 dimension_id,
							      bool  delete_constraints);
extern int	     dimension_slice_delete_by_id(int32 dimension_slice_id,
						    bool  delete_constraints);
extern DimensionSlice *dimension_slice_create(int dimension_id, int64 range_start,
					      int64 range_end);
...
extern bool dimension_slice_cut(DimensionSlice *to_cut, DimensionSlice *other,
				int64 coord);
...
#define dimension_slice_insert(slice) dimension_slice_insert_multi(&(slice), 1)
