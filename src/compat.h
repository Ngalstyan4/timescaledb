...
#define InitResultRelInfoCompat(                                                         \
    result_rel_info, result_rel_desc, result_rel_index, instrument_options)              \
	InitResultRelInfo(result_rel_info,                                               \
			  result_rel_desc,                                               \
			  result_rel_index,                                              \
			  NULL,                                                          \
			  instrument_options)
...
#define map_variable_attnos_compat(                                                      \
    returning_clauses, varno, sublevels_up, map, map_size, rowtype, found_whole_row)     \
...
#define map_variable_attnos_compat(                                                      \
    expr, varno, sublevels_up, map, map_size, rowtype, found_whole_row)                  \
	map_variable_attnos(expr, varno, sublevels_up, map, map_size, found_whole_row)
#define ExecBuildProjectionInfoCompat(tl, exprContext, slot, parent, inputdesc)          \
	ExecBuildProjectionInfo(                                                         \
	    (List *) ExecInitExpr((Expr *) tl, NULL), exprContext, slot, inputdesc)
