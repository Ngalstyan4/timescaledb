...
extern HypertableRestrictInfo *hypertable_restrict_info_create(RelOptInfo *rel,
							       Hypertable *ht);

/* Add restrictions based on a List of RestrictInfo */
extern void hypertable_restrict_info_add(HypertableRestrictInfo *hri, PlannerInfo *root,
...
extern List *hypertable_restrict_info_get_chunk_oids(HypertableRestrictInfo *hri,
