...
extern SubspaceStore *subspace_store_init(Hyperspace *space, MemoryContext mcxt,
					  int16 max_items);

/* Store an object associate with the subspace represented by a hypercube */
extern void subspace_store_add(SubspaceStore *cache, const Hypercube *hc, void *object,
